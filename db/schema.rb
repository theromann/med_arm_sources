...
ActiveRecord::Schema.define(:version => 20140616103745) do
  ...
  create_table "arm_statuses", :force => true do |t|
    ...
    t.integer "issue_statuses",               :default => 1
    t.integer "position",                     :default => 1
    t.integer "integer",                      :default => 1
  end

  add_index "arm_statuses", ["is_default"], :name => "index_arm_statuses_on_is_default"
  add_index "arm_statuses", ["is_final"], :name => "index_arm_statuses_on_is_final"
  add_index "arm_statuses", ["position"], :name => "index_arm_statuses_on_position"
